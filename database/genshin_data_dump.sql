...
CREATE TABLE `user_character` (
  ...
  `character_name` varchar(20) NOT NULL,
  `constellation_lvl` int DEFAULT NULL,
  `talent_lvl` int DEFAULT NULL,
  `weapon_id` int DEFAULT NULL,
  PRIMARY KEY (`character_id`),
  KEY `user_gs_character` (`character_name`),
...
CREATE TABLE `user_team` (
  ...
  `character_id1` int DEFAULT NULL,
  `character_id2` int DEFAULT NULL,
  `character_id3` int DEFAULT NULL,
  `character_id4` int DEFAULT NULL,
  PRIMARY KEY (`team_id`),
  KEY `character_id1` (`character_id1`),
  KEY `character_id2` (`character_id2`),
  KEY `character_id3` (`character_id3`),
  KEY `character_id4` (`character_id4`),
  CONSTRAINT `user_team_ibfk_1` FOREIGN KEY (`character_id1`) REFERENCES `user_character` (`character_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `user_team_ibfk_2` FOREIGN KEY (`character_id2`) REFERENCES `user_character` (`character_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `user_team_ibfk_3` FOREIGN KEY (`character_id3`) REFERENCES `user_character` (`character_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `user_team_ibfk_4` FOREIGN KEY (`character_id4`) REFERENCES `user_character` (`character_id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
	...
	JOIN (
		SELECT team_id, element, COUNT(element) AS elementNo FROM (
			...
			WHERE team_id = NEW.team_id
				AND (ut.character_id1 = uc.character_id
					OR ut.character_id2 = uc.character_id
					OR ut.character_id3 = uc.character_id 
					OR ut.character_id4 = uc.character_id)
...
CREATE TABLE `user_weapon` (
  ...
  `weapon_name` varchar(50) NOT NULL,
  `refinement_lvl` int DEFAULT NULL,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `find_resonance` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `find_resonance`(
	team_no 	INT
)
BEGIN
	SELECT team_id, er.resonance_type FROM gs_elemental_resonance AS er 
